...
export default function CampaignHistory() {
  ...
  const getStatusBadge = (status: Campaign['status']) => {
    const statusConfig = {
      completed: { color: 'bg-green-100 text-green-800', label: 'Completada', icon: 'fas fa-check-circle' },
      'in-progress': { color: 'bg-blue-100 text-blue-800', label: 'En Progreso', icon: 'fas fa-spinner' },
      scheduled: { color: 'bg-yellow-100 text-yellow-800', label: 'Programada', icon: 'fas fa-clock' },
      cancelled: { color: 'bg-red-100 text-red-800', label: 'Cancelada', icon: 'fas fa-times-circle' }
    };
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Historial de Campañas</h1>
          <p className="text-gray-600">Revisa el rendimiento y resultados de tus campañas de marketing</p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
          ...
          <h3 className="text-gray-600 text-sm font-medium mb-1">Total Campañas</h3>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
          ...
          <h3 className="text-gray-600 text-sm font-medium mb-1">Completadas</h3>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {sortedAndFilteredCampaigns.map((campaign) => (
                <tr key={campaign.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                    <span className="text-green-600 font-medium">{campaign.sent.toLocaleString()}</span>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                    <span className="text-red-600 font-medium">{campaign.errors.toLocaleString()}</span>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
